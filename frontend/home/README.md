...
站头横幅只有首页全幅显示（`--mast-ratio`，1920:550）。点主导航里的栏目进入内页后，站头收窄为 `--mast-ratio-folded`（1920:387，保留横幅上部约七成、图片按顶部对齐裁切，比例取自设计稿截图），导航条以下的主体整体上提，露出更多内容；收缩态不再显示“政治协商 民主监督 参政议政”标语。
